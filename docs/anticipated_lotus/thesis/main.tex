...
\usepackage[backend=biber,style=numeric-comp,sorting=none, maxbibnames=99]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)

\addbibresource{/Users/Marco/BibTex/BibTex.bib} % The filename of the bibliography
...
\department{\href{https://www.unifr.ch/bio/en/}{Department Biology}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
