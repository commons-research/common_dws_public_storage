...
\begin{tikzpicture}[node distance={25mm}, thick, main/.style = {draw, circle}]
	\node[main] (1) {$\overrightarrow{\boldmath{x_s}}$};
	\node[main] (2) [above left of=1] {$\overrightarrow{\mu}$};
	\node[main] (3) [above right of=1] {$\overrightarrow{\alpha}$};
	\node[draw, thick] (4) [below right of=1] {$d_{sj}$};
	\node[draw] (5) [below left of=1] {$\overrightarrow{L_s}$};
	\node[main] (6) [above right of=4] {$\overrightarrow{\epsilon_j}$};
